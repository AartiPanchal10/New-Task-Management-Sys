...
const InputData = ({ InputDiv, setInputDiv, updatedData, setUpdatedData, fetchTasks }) => {
  ...
  const submitData = async () => {
    if (Data.title === "" || Data.description === "" || Data.assignedTo === "" || Data.dueDate === "") {
      ...
      try {
        await axios.post("https://new-task-management-sys-production.up.railway.app/api/v2/create-task", Data, { headers });
        alert("Task Created.");
  ...
  const updateTask = async () => {
    if (Data.title === "" || Data.description === "" || Data.assignedTo === "" || Data.dueDate === "") {
      ...
      try {
        await axios.put(`https://new-task-management-sys-production.up.railway.app/api/v2/update-task/${updatedData.id}`, Data, { headers });
        alert("Task Updated.");
